   ...
   return (
      <div className="p-4 md:p-10 space-y-6 md:space-y-10 bg-background max-w-[1600px] mx-auto overflow-hidden">
         ...
         <div className="flex flex-col items-center justify-center text-center border-b border-border pb-6 md:pb-8 gap-4">
            ...
            <div className="bg-muted px-4 md:px-8 py-3 md:py-4 border border-border flex flex-wrap items-center justify-center gap-4 md:gap-10 rounded-2xl">
               ...
               <div className="hidden sm:block w-px h-6 md:h-8 bg-border" />
               <div className="text-center">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {/* Total Revenue */}
            <div className="bg-card border border-border rounded-2xl p-4 md:p-6 shadow-sm relative overflow-hidden group hover:border-primary transition-all">
            ...
            {/* User Stats */}
            <div className="bg-card border border-border rounded-2xl p-4 md:p-6 shadow-sm group hover:border-blue-500 transition-all">
            ...
            <div className="bg-card border border-border rounded-2xl p-4 md:p-6 shadow-sm group hover:border-purple-500 transition-all">
         ...
         <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="xl:col-span-2 bg-card border border-border rounded-2xl shadow-sm p-4 md:p-6">
               ...
               <div className="h-[250px] md:h-[350px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                     <AreaChart data={stats.trends.daily}>
                        ...
                        />
                        <Tooltip
                           contentStyle={{ backgroundColor: '#fff', border: '1px solid #e5e7eb', borderRadius: '12px', boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.1)', fontSize: '10px' }}
            ...
            <div className="bg-card border border-border rounded-2xl shadow-sm p-4 md:p-6">
               ...
               <div className="h-[250px] md:h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                     <BarChart data={stats.trends.risk}>
                        ...
                        <Tooltip
                           cursor={{ fill: '#f1f1f1' }}
                           contentStyle={{ borderRadius: '12px', border: '1px solid #e5e7eb', fontSize: '10px' }}
                        />
               ...
               <div className="mt-4 p-3 md:p-4 bg-muted/50 border border-dashed border-border flex flex-col xs:flex-row items-center justify-between gap-3 rounded-xl">
                  <p className="text-[9px] md:text-[10px] font-black uppercase opacity-60">{t("admin.risk_level_today")}</p>
                  <span className={`px-3 py-1 text-[9px] md:text-[10px] font-black uppercase rounded-lg ${stats.overview.pending_reports > 5 ? 'bg-red-500 text-white' : 'bg-green-500 text-white'}`}>
         ...
         <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="space-y-4">
               ...
               <div className="space-y-3">
                  {stats.recent_alerts?.length > 0 ? stats.recent_alerts.slice(0, 5).map((alert: any) => (
                     <Link key={alert.id} href="/admin/ai-security" className="block bg-card border border-border rounded-2xl p-3 md:p-4 hover:border-red-500 shadow-sm transition-all relative group">
                        <div className="flex items-center gap-3 md:gap-4">
                           <div className="w-10 h-10 md:w-12 md:h-12 bg-red-500/10 flex items-center justify-center text-red-500 shrink-0 rounded-xl">
                     ...
                     <div className="p-8 md:p-12 text-center border-2 border-dashed border-border opacity-30 select-none rounded-2xl">
            ...
            <div className="space-y-4">
               ...
               <div className="bg-card border border-border rounded-2xl shadow-sm overflow-hidden overflow-x-auto custom-scrollbar">
