                  ...
                  <AnimatePresence mode="popLayout">
                    {addresses.length === 0 ? (
                      ...
                      addresses.map((addr, idx) => (
                        ...
                        >
                          <Card className="rounded-[2.5rem] border border-white/20 dark:border-slate-800/10 bg-white/40 dark:bg-slate-900/40 backdrop-blur-3xl p-8 hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 relative isolate focus-within:z-20">
